...
<head>
    ...
    <link href="/front/bootstrap-3.3.2-dist/css/front_css.css" rel="stylesheet">
</head>
<body class="container-fluid">

<div id="head" class="container-fluid">
    <a href="#"><img class="img-responsive col-sm-3 col-xs-5" src="/front/resource/icon/wwwMark2.png" id="logo"></a>
</div>
...
<div class="container">
    <section id="box" class='row'>
        <div id="information" class="col-md-5 col-sm-10 col-sm-offset-1 col-xs-12">
            ...
            <form action="file:///Users/hyoya/Desktop/WEB/inside.html">
