...
<head>
  ...
  <link href="/front/bootstrap-3.3.2-dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="/front/bootstrap-3.3.2-dist/css/galleryInfo.css" rel="stylesheet">
</head>
<body>
          ...
          <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" id="caro">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <img src="/front/resource/img/1.jpeg">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
                <div class="item">
                  <img src="/front/resource/img/2.jpeg">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
                ...
                <div class="item">
                  <img src="/front/resource/img/3.jpeg">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
